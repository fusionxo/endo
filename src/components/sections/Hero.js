...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-custom mx-auto px-4 text-center text-text-primary">
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <a 
              href="https://www.instagram.com/p/DNunGfg3hA7/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-2 text-text-primary hover:text-accent-400 transition-colors"
            >
